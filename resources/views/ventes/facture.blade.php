...
<head>
    ...
    <style>
        ...
        .facture-info div { width: 48%; }
        .facture-info h4 { color: #1e293b; border-bottom: 2px solid #3b82f6; padding-bottom: 5px; }
        ...
        .total-section table td { border: none; padding: 4px 8px; }
        .total-final { font-size: 16px; font-weight: bold; color: #1e293b; }
        .paiement { margin-top: 20px; padding: 10px; background: #f0fdf4; border-left: 4px solid #22c55e; }
...
<body>
    ...
    <div class="total-section">
        <table>
            ...
            <tr class="total-final">
                <td>Total TTC :</td>
                <td>{{ number_format($vente->montant_total * 1.20, 2) }} DH</td>
            </tr>
        </table>
    </div>
    ...
    <div class="footer">
        <p>Merci pour votre confiance. Document généré le {{ now()->format('d/m/Y H:i') }}</p>
    </div>
